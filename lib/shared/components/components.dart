...
import 'package:first_app/modules/web_view/web_view.dart';
...
Widget buildListProduct(model, context,
        {bool isOldPrice = true, bool favorites = true}) =>
    Padding(
      padding: const EdgeInsets.all(20.0),
      child: Container(
        height: 120.0,
...
class CreatePostRoute<T> extends PageRoute<T> {
  CreatePostRoute(
...
class CommentRoute<T> extends PageRoute<T> {
  CommentRoute(
      {required WidgetBuilder builder,
      RouteSettings? settings,
      bool fullScreenDialog = false})
  ...
  @override
  // TODO: implement barrierLabel
  String? get barrierLabel => 'Comment';
